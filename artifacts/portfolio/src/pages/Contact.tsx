...
import { Mail, Github, Linkedin, ExternalLink, Send, MapPin, BookOpen, Download, MessageSquare } from "lucide-react";
            ...
            >
              ...
              <div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {profile?.cvUrl && (
                    <Dialog>
                      <DialogTrigger className="group flex items-center gap-3 px-4 py-3 rounded-xl text-muted-foreground/70 hover:text-foreground border border-transparent hover:border-white/[0.08] hover:bg-white/[0.03] transition-all duration-200">
                        <BookOpen className="w-4 h-4 group-hover:text-primary transition-colors" />
                        <span className="text-sm font-medium">Voir le CV</span>
                        <ExternalLink className="w-3.5 h-3.5 ml-auto opacity-0 group-hover:opacity-50 transition-opacity" />
                      </DialogTrigger>
                      <DialogContent className="max-w-[95vw] w-[min(95vw,1200px)] max-h-[95vh] overflow-hidden p-0 sm:rounded-3xl">
                        <div className="flex h-full flex-col">
                          <DialogHeader className="px-6 pt-6">
                            <DialogTitle>Curriculum Vitae</DialogTitle>
                            <DialogDescription className="text-sm text-muted-foreground/70">
                              Visualisez le CV et téléchargez-le si besoin.
                            </DialogDescription>
                          </DialogHeader>
                          <div className="flex-1 bg-slate-950 min-h-[72vh]">
                            <iframe
                              src={profile.cvUrl}
                              title="CV PDF"
                          ...
                          <DialogFooter className="flex flex-col gap-3 px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
                            <p className="text-sm text-muted-foreground/70">Le CV est affiché en grand ici.</p>
                            <a
                              href={profile.cvUrl}
                              target="_blank"
